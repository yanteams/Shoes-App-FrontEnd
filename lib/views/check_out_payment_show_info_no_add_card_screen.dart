...
class CheckOutPaymentShowInfoNoAddCardScreen extends StatelessWidget {
  CheckOutPaymentShowInfoNoAddCardScreen({Key? key})
      : super(
          key: key,
        );
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Savannah Nguyen",
                                style:
                                    CustomTextStyles.titleMediumBluegray400_1,
                              ),
                              SizedBox(height: 17.v),
                              Text(
