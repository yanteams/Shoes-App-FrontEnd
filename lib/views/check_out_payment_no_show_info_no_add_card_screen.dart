...
class CheckOutPaymentNoShowInfoNoAddCardScreen extends StatelessWidget {
  CheckOutPaymentNoShowInfoNoAddCardScreen({Key? key})
      : super(
          key: key,
        );
  ...
  TextEditingController maximizeController = TextEditingController();

  TextEditingController paymentbycardlaController = TextEditingController();

  TextEditingController addnewcreditController = TextEditingController();
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              CustomTextFormField(
                                controller: paymentbycardlaController,
                              ...
                              SizedBox(height: 20.v),
                              CustomTextFormField(
                                controller: addnewcreditController,
                                ...
                                borderDecoration:
                                    TextFormFieldStyleHelper.outlineGrayTL121,
                                filled: false,
                              ),
                            ],
                          ),
