...
class ShopDetailProductContainerScreen extends StatelessWidget {
  ShopDetailProductContainerScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            body: Navigator(
                key: navigatorKey,
                initialRoute: AppRoutes.shopDetailProductPage,
